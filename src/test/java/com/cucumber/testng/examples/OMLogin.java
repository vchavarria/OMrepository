...
private StringBuffer verificationErrors = new StringBuffer();
	...
	public void user_enters_a_valid_user_name() throws Throwable {
	    ...
	    Login_Page.txtbx_UserName(driver).sendKeys("vchavarria");
	...
	public void user_enters_a_valid_password() throws Throwable {
		...
		Login_Page.txtbx_Password(driver).sendKeys("Daniel2006");
	...
	public void user_enters_a_Reviewer_invalid_user_name() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
		 assertEquals(driver.getTitle(), "Cambridge Associates - Sign In");
		    Login_Page.txtbx_UserName(driver).clear();
		    Login_Page.txtbx_UserName(driver).sendKeys("vchava");
	    //throw new PendingException();
	}
	...
	public void user_enters_an_Reviewer_invalid_password() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
		Login_Page.txtbx_Password(driver).clear();
		Login_Page.txtbx_Password(driver).sendKeys("Daniel2007");
	    //throw new PendingException();
	}
