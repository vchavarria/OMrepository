...
// Strict: ** **if strict option is set to false then at execution time if
// cucumber encounters any undefined/pending steps then cucumber does not fail
// the execution and undefined steps are skipped and BUILD is SUCCESSFUL.
