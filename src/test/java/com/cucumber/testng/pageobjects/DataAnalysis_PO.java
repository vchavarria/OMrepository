...
public class DataAnalysis_PO {
	...
	@FindBy(how = How.XPATH, using = "/html/body/div/div/div/main/div/omreport/section/div/div[1]/section/div/div[2]/div/div[1]/div[1]/div[3]/div")
	public static WebElement Rpt_PPMCompTyp;

	@FindBy(how = How.XPATH, using = "/html/body/div/div/div/main/div/omreport/section/div/div[1]/section/div/div[2]/div/div[1]/div[1]/div[5]/div")
	public static WebElement Rpt_PPMSector;

	@FindBy(how = How.XPATH, using = "/html/body/div/div/div/main/div/omreport/section/div/div[1]/section/div/div[2]/div/div[1]/div[1]/div[1]")
	public static WebElement Typ_Report;
